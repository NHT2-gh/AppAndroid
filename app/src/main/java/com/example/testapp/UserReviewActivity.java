...
public class UserReviewActivity extends AppCompatActivity {
    ...
    private void setEvent() {
        ArrayList<OrderDetail> receivedOrderList = getIntent().getParcelableArrayListExtra("orderList");
        if (receivedOrderList != null) {
            Log.i("listReview", String.valueOf(receivedOrderList.get(0).getProduct().getProduct_name()));
